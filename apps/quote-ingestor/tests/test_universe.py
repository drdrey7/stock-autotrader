...
SYMBOLS = "AAPL ADBE AFRM AMAT AMD AMZN ARM ASML AVGO COIN COST CRM CRWD CRWV DDOG DELL GOOGL GS HOOD INTC JPM KLAC LLY LRCX MA META MRVL MSFT MU NBIS NET NFLX NOW NVDA NVO ORCL PANW PLTR QCOM RDDT SHOP SNDK SNOW SOFI TSLA TSM UBER UNH V WMT".split()
