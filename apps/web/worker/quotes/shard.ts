 ...
 * 10 shards × 5 symbols with no duplication and no loss. Adding or removing
 ...
 * market-closed gaps; consecutive in-session minutes cycle 0..9, refreshing
 * every symbol about once every ten minutes (10 shards × 5 symbols).
 */
